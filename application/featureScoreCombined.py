...
if __name__ == "__main__":
    ...
    plot_feature_importance(feature_importances, combined_feature_names, output_subdir, 
    ...
    plot_feature_importance(perm_importance.importances_mean, combined_feature_names, output_subdir, 
    ...
    importance_data.to_csv(os.path.join(output_subdir, 'combined_feature_importance_scores.csv'), index=False)

    print(f"[INFO] Combined feature scoring completed and saved to {output_subdir}")